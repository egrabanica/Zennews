...
const categories = {
  technology: {
    name: 'Technology',
    description: 'Latest news and insights in tech.',
  },
  business: {
    name: 'Business',
    description: 'Updates on markets, companies, and economies.',
  },
  entertainment: {
    name: 'Entertainment',
    description: 'Celebrity gossip, movies, music, and more.',
  },
  politics: {
    name: 'Politics',
    description: 'Political news and analysis worldwide.',
  },
};
  ...
  return (
    <section className="container mx-auto px-4 py-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {/* Map over your articles filtered by category here */}
        <Card>
          <Link href={`/article/sample-1`}>
            <a className="block p-4 hover:bg-gray-50">
              <h2 className="text-xl font-semibold">Sample Article 1</h2>
              <Badge className="mt-2">{category.name}</Badge>
            </a>
          </Link>
        </Card>
        {/* …more cards… */}
